...
tape( 'if provided `0`, the function returns `NaN`', opts, function test( t ) {
	var val = trigamma( 0.0 );
	t.strictEqual( isnan( val ), true, 'returns expected value' );
	t.end();
});

tape( 'if provided positive infinity, the function returns `0`', opts, function test( t ) {
...
tape( 'the function evaluates the trigamma function for positive numbers', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function evaluates the trigamma function for negative numbers', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
